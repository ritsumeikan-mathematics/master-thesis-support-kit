...
| `04_master_thesis_usage_guidelines.md` | 安全かつ倫理的に利用するための運用ガイドライン。 |

## 基本的な使い方
1. **初期設定**: 新しいチャットセッションを開始したら、まず `01_...` の内容をコピー＆ペーストしてAIに読み込ませてください。
2. **テンプレートの利用**: 相談したい内容に合わせて `02_...` または `03_...` から適切なテンプレートをコピーし、`[ ]` で囲まれたプレースホルダー部分を自分の文章に書き換えて送信してください。
3. **ガイドラインの確認**: 作業を始める前に、必ず `04_...` を読み、AIとの適切な距離感を確認してください。
